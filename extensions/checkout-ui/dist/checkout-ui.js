...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/utils/validateNip.ts
  var validateNip = (nip, translations) => {
  ...
  // extensions/checkout-ui/locales/en.default.json
  var en_default_default = {
    individual: "Individual",
    business: "Business",
    companyName: "Company Name",
    nip: "NIP",
    nipError: "Invalid NIP",
    nipInvalidLength: "Invalid NIP. It should have 10 digits.",
    nipInvalidControlNumber: "Invalid NIP. Control number is incorrect.",
    nipControlNumberMismatch: "Invalid NIP. Control number does not match."
  };
  ...
  function Extension() {
    ...
    const [isBusiness, setIsBusiness] = (0, import_react16.useState)(false);
    const [companyName, setCompanyName] = (0, import_react16.useState)("");
    const [nip, setNip] = (0, import_react16.useState)("");
    const [nipError, setNipError] = (0, import_react16.useState)("");
    (0, import_react16.useEffect)(() => {
      const loadMetafiles = () => {
        ...
        if ((customerType == null ? void 0 : customerType.value) === "business") {
          setIsBusiness(true);
        }
        if (companyNameField) {
        ...
        if (nipField) {
          ...
          setNip(nipValue);
          const error = validateNip(nipValue, en_default_default);
          setNipError(error);
        }
      };
    ...
    (0, import_react16.useEffect)(() => {
      setNipError(nip ? validateNip(nip, en_default_default) : "");
    }, [nip]);
    const submitAdditionalInfo = (0, import_react16.useCallback)(() => __async(this, null, function* () {
      if (!isBusiness)
        return;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { spacing: "loose", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(InlineStack2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: !isBusiness, onChange: () => setIsBusiness(false), children: en_default_default.individual }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { checked: isBusiness, onChange: () => setIsBusiness(true), children: en_default_default.business })
      ] }),
      isBusiness && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          TextField2,
          {
            label: en_default_default.companyName,
            value: companyName,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          TextField2,
          {
            label: en_default_default.nip,
            value: nip,
            onChange: setNip,
            error: nipError
          }
        ),
        nipError && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "critical", children: nipError })
      ] })
    ] });
  }
})();
